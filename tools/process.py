...
# combine
parser.add_argument("--gt_dir", type=str, help="path to folder containing B images for combine operation")
a = parser.parse_args()
...
def combine(src, src_path):
    if a.gt_dir is None:
        raise Exception("missing gt_dir")

    # find corresponding file in gt_dir, could have a different extension
    basename, _ = os.path.splitext(os.path.basename(src_path))
    for ext in [".png", ".jpg"]:
        sibling_path = os.path.join(a.gt_dir, basename + ext)
